...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivityLog.player'
        db.delete_column(u'players_activitylog', 'player_id')

        # Adding field 'ActivityLog.to_player'
        db.add_column(u'players_activitylog', 'to_player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='activitylog_to_player', to=orm['players.Player']),
                      keep_default=False)

        # Adding field 'ActivityLog.from_player'
        db.add_column(u'players_activitylog', 'from_player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='activitylog_from_player', to=orm['players.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ActivityLog.player'
        db.add_column(u'players_activitylog', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['players.Player']),
                      keep_default=False)

        # Deleting field 'ActivityLog.to_player'
        db.delete_column(u'players_activitylog', 'to_player_id')

        # Deleting field 'ActivityLog.from_player'
        db.delete_column(u'players_activitylog', 'from_player_id')
    ...
    models = {
        ...
        u'players.activitylog': {
            'Meta': {'object_name': 'ActivityLog'},
            'activity_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activitylog_from_player'", 'to': u"orm['players.Player']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'to_player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activitylog_to_player'", 'to': u"orm['players.Player']"})
        },
        u'players.armor': {
