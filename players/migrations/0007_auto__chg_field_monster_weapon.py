...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Monster.weapon' to match new field type.
        db.rename_column(u'players_monster', 'weapon_id', 'weapon')
        # Changing field 'Monster.weapon'
        db.alter_column(u'players_monster', 'weapon', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Removing index on 'Monster', fields ['weapon']
        db.delete_index(u'players_monster', ['weapon_id'])


    def backwards(self, orm):
        # Adding index on 'Monster', fields ['weapon']
        db.create_index(u'players_monster', ['weapon_id'])


        # Renaming column for 'Monster.weapon' to match new field type.
        db.rename_column(u'players_monster', 'weapon', 'weapon_id')
        # Changing field 'Monster.weapon'
        db.alter_column(u'players_monster', 'weapon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Weapon']))
