...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityLog.viewed'
        db.add_column(u'players_activitylog', 'viewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityLog.viewed'
        db.delete_column(u'players_activitylog', 'viewed')
