...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Player', fields ['handle']
        db.create_unique(u'players_player', ['handle'])


    def backwards(self, orm):
        # Removing unique constraint on 'Player', fields ['handle']
        db.delete_unique(u'players_player', ['handle'])
    ...
    models = {
        ...
        u'players.player': {
            ...
            'here_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
