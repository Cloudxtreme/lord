...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'players_battlelog')

        # Adding model 'ActivityLog'
        db.create_table(u'players_activitylog', (
            ...
            ('activity_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'players', ['ActivityLog'])


    def backwards(self, orm):
        # Adding model 'BattleLog'
        db.create_table(u'players_battlelog', (
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('attacker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attacker', to=orm['players.Player'])),
            ('defender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='defender', to=orm['players.Player'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'players', ['BattleLog'])

        # Deleting model 'ActivityLog'
        db.delete_table(u'players_activitylog')
